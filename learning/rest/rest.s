...
main:
        ...
        ; config
        ldi r16, 0x0C ; numerador = 12
        ldi r17, 0x04 ; denominador = 4
        mov r18, r16 ; r18 -> backup numerador

sub:
        sub r16, r17 ; numerador - denominador
        cp r16, r17  ; numerador >= denominador ?
        brge sub    ; se sim, repete
        rjmp wait
